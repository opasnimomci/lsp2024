...
class MainMenu:
    ...
    def DrawMainMenu(self):
        ...
        textS = font.render("Easter Egg:", True, "white")
        if game_data['freaky']:
            screen.blit(bob, (50, 400))
        else:
            screen.blit(locked, (50, 400))
        RectS = textS.get_rect()
...
def freakycredits(credits_speed, credits_time):
    ...
    while running:
        ...
        credits_speed += 0.2
        screen.fill(yellow)
        screen.blit(bob, (580, credits_speed))
        screen.blit(bob, (580, -400  + credits_speed))
        screen.blit(bob, (580, -700 + credits_speed))
        screen.blit(bob, (580, -1000 + credits_speed))
        screen.blit(bob, (580, -1300 + credits_speed))
        screen.blit(bob, (580, -1600 + credits_speed))
        screen.blit(bob, (580, -1900 + credits_speed))
        screen.blit(bob, (580, -2200 + credits_speed))
        credits_time -= 0.001
        if (credits_time < 0):
                    return
        pg.display.update()
...
while True:
    if singlplayer == False and multiplayer == False and mainmenu == False:
        if credits and game_data['freaky']:
            freakycredits(0,5)
            import freakybounce
        break
    if mainmenu:
